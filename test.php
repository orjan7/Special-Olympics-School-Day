...
//             if ($row3[$y] == 0) {
//                 $branch[] = $tab.$tab.$tab.$tab.$tab.'<td><input type="checkbox" name="checkbox[]" id="myCheck" value="'.$branchCheck[$y].'" oncklick="checkbranch()"></td>'.$nl;
//             }
//             else {
//                 $branch[] = $tab.$tab.$tab.$tab.$tab.'<td><input type="checkbox" name="checkbox[]" id="myCheck" value="'.$branchCheck[$y].'" oncklick="checkbranch()" checked></td>'.$nl;
//             }
//         }
//     }
//     echo '<p id="text" style="display:none>Det funderar</p>';
//     echo '<script>function checkbranch() {
...
//         }
//     }<script>';
//     echo $nl.'<form action="actiontest.php" method="post">'.$nl;
...
//             }
//             echo $tab.$tab.'<input type="hidden" name="site" value="'.$fromSite.'">'.$nl;
